...
public class ObjectPatternMatch {
    ...
    public static void matchProc(Object o, MatchCase... cos){
        for(MatchCase co : cos){
            if(co.match(o)) return;
        }
        //throw new RuntimeException("no match");
    }
    public static <T> CaseOf<T> caseOfProc(Class<T> cls, Consumer<T> proc){
        return new CaseOf<>(cls, proc);
    }
    public static MatchCase noMatchProc(Runnable proc){
    ...
    public static <R> R match(Object o, MatchCaseRet<R>... cors){
    ...
    public static <T, R> CaseOfRet<T, R> caseOf(Class<T> cls, Function<T, R> func){
        return new CaseOfRet<>(cls, func);
    }
    public static<R> MatchCaseRet<R> noMatch(Supplier<R> sup){
